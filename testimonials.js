const testimonialsData = [
  ...
  },
  {
    ...
    reply: "Cảm ơn chú Sáng đã tin dùng sản phẩm của Atlantis. Đội ngũ kỹ thuật luôn sẵn sàng hỗ trợ 24/7 ạ."
  },
  {
    id: 4,
    stars: 5,
    content: "Điều làm tôi thích nhất ở Atlantis là lớp vỏ chống nóng 3 lớp. Nhà đông cháu nhỏ chạy qua lại mà chạm vào vỏ nồi chỉ thấy hơi ấm ấm chứ không lo bỏng.",
    avatar: "image/feaback4.jpg",
    name: "Hoàng Quốc Bảo",
    date: "2024-01-05 10:15",
    tags: ["An toàn khi sử dụng", "Thiết kế thông minh"],
    reply: "Cảm ơn chú đã phản hồi tích cực. Sự an toàn của khách hàng luôn là ưu tiên hàng đầu của Atlantis."
  }
];
